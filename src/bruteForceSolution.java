...
public class bruteForceSolution {
    ...
    public bruteForceSolution(int[][] board, int size, int turn) {
        this.board = board;
        this.size = size;
        this.turn = turn;
    }
    ...
    public void solution() {
        ...
        List<String> bestMove = findBestMoveBruteForce(listPiece);
        if (bestMove.isEmpty()) {
    ...
    public List<String> findBestMoveBruteForce(List<String> listPiece) {
        ...
        bestMoves.add(0, bestPiece); // Add the initial position to the bestMoves list
        return bestMoves;
    }
